...
declare module 'vue-router/auto-routes' {
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/ContractsPage.vue': {
      routes:
        | '/ContractsPage'
      views:
        | never
    }
    'src/pages/DepositsPage.vue': {
      routes:
        | '/DepositsPage'
      views:
        | never
