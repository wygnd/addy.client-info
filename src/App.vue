    ...
    >
      <B24Main as="div" class="min-h-[75dvh]">
        ...
        >
          ...
          />
          <B24PageBody
            class="m-0 gap-20 h-[90dvh] overflow-y-auto p-5 rounded-(--ui-border-radius-md) bg-(--ui-color-design-outline-bg) border-(--ui-color-design-outline-stroke) border-(length:--ui-design-outline-stroke-weight) text-(--ui-color-design-outline-content) flex-1 w-full overflow-auto"
          >
            <RouterView />
          </B24PageBody>
        </B24Container>
